...
$pPreset.Location  = New-Object System.Drawing.Point(8, 290)
...
$Script:btnLedvStart = Make-Btn $spI "Ausgewaehlte Installation starten" 370 428 260 36 $cAccent { Invoke-AdminLedvInstall }
